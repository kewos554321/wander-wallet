...
export function DebugOverlay() {
  ...
  if (!isExpanded) {
    return (
      <button
        ...
        className="fixed bottom-24 right-3 z-[9999] w-10 h-10 bg-black/80 backdrop-blur rounded-full border border-slate-600 shadow-xl flex items-center justify-center"
      >
  ...
  return (
    <div className="fixed bottom-24 left-2 right-2 z-[9999] max-h-[30vh] bg-black/95 backdrop-blur rounded-lg border border-slate-700 shadow-xl text-xs font-mono">
      {/* Header */}
